...
/**
 * SenderIdVertexIdMessages
 *
 * @param <I> vertexId type parameter
 * @param <M> message type parameter
 */
public interface SenderIdVertexIdMessages<I extends WritableComparable,
        M extends Writable> extends SenderIdVertexIdData<I, M> {
    /**
     ...
     */
    SenderIdVertexIdMessageBytesIterator< I, M> getSenderIdVertexIdMessageBytesIterator();
     ...
     *         specified
     */
    SenderIdVertexIdMessageIterator<I, M> getSenderIdVertexIdMessageIterator();
