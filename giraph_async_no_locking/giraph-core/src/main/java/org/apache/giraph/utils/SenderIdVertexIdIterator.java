 ...
 * @param <I> Vertex id
 */
public interface SenderIdVertexIdIterator< I extends WritableComparable> {
    /**
    ...
    SenderIdIterationNumber getCurrentSenderId();
    ...
    SenderIdIterationNumber releaseCurrentSenderId();
}
