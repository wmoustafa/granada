...
public class ServerData<I extends WritableComparable,
   ...
   */
  private volatile MessageStore<I, Writable> incomingExtendedMessageStore;
   ...
   * @return Incoming message store
   */
  public <M extends Writable> MessageStore<I, M> getIncomingExtendedMessageStore() {
    return (MessageStore<I, M>) incomingExtendedMessageStore;
  }
  ...
  public void prepareSuperstep() {
    ...
    currentMessageStore = incomingMessageStore != null ? incomingMessageStore :
            messageStoreFactory.newStore(conf.getIncomingMessageClasses());

    incomingMessageStore =  messageStoreFactory.newStore(conf.getOutgoingMessageClasses());
    incomingExtendedMessageStore =  new LongByteArrayExtendedMessageStore(
                    conf.getOutgoingMessageClasses().createMessageValueFactory(conf),this.getServiceWorker(), conf);
