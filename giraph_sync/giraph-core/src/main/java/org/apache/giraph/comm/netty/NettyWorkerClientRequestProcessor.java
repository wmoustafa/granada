...
public class NettyWorkerClientRequestProcessor<I extends WritableComparable,
  ...
  public void flush() throws IOException {
    ...
    //LOG.debug("Vicky SYNC --> flush send data cache");
  ...
  public long resetMessageCount() {
    ...
    long totalMsgSent = this.sendMessageCache.resetMessageCount();
  ...
  public long resetMessageBytesCount() {
    ...
    long totalMsgBytes = this.sendMessageCache.resetMessageBytesCount();
