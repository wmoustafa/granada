...
public interface WorkerClientRequestProcessor<I extends WritableComparable,
   ...
   * @param message Message to send.
   */
  void sendExtendedMessageRequest(Vertex<I, V, E> vertex, I destVertexId, Writable message);
   ...
   * @param message  Message to send.
   */
  void sendExtendedMessageToAllRequest(Vertex<I, V, E> vertex, Writable message);
   ...
   * @param message  Message to send.
   */
  void sendExtendedMessageToAllRequest(Iterator<I> vertexIdIterator, Writable message);
