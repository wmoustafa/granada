 ...
 */
public class ByteStructSenderIdVertexIdMessageIterator<I extends WritableComparable,
        M extends Writable> extends ByteStructSenderIdVertexIdDataIterator<I, M>
        implements SenderIdVertexIdMessageIterator< I, M> {

    // Vicky
    /** Class logger */
    private static final Logger LOG =
            Logger.getLogger(ByteStructVertexIdMessageIterator.class);
     ...
     */
    public ByteStructSenderIdVertexIdMessageIterator(
            AbstractSenderIdVertexIdData< I, M> vertexIdData) {
        super(vertexIdData);
    }
