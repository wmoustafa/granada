...
public abstract class SendExtendedDataCache<D> {

    /** Class logger */
    private static final Logger LOG = Logger.getLogger(SendExtendedDataCache.class);
     ...
     */
    public SendExtendedDataCache(ImmutableClassesGiraphConfiguration conf,
    ...
    removeWorkerData(WorkerInfo workerInfo) {
        ...
        for (Integer partitionId : partitions) {
            if (dataCache[partitionId] != null) {
                ...
                /*LOG.debug("Vicky --> removeWorkerData workerData size = " + workerData.getSize());
