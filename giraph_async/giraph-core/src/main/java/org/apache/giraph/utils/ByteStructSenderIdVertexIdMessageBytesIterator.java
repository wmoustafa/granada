 ...
 */
@NotThreadSafe
public abstract class ByteStructSenderIdVertexIdMessageBytesIterator<
        I extends WritableComparable, M extends Writable>
        extends ByteStructSenderIdVertexIdDataIterator< I, M>
        implements SenderIdVertexIdMessageBytesIterator< I, M> {
     ...
     */
    public ByteStructSenderIdVertexIdMessageBytesIterator(
    ...
    public void next() {
        if (senderId == null) {
            senderId = new SenderIdIterationNumber();
        }
