 ...
 */
@NotThreadSafe
public class ByteStructSenderIdVertexIdDataIterator< I extends WritableComparable, T>
        extends ByteStructSenderIdVertexIdIterator<I> implements SenderIdVertexIdDataIterator<I, T> {

    /** VertexIdData to iterate over */
    protected AbstractSenderIdVertexIdData<I, T> vertexIdData;
     ...
     */
    public ByteStructSenderIdVertexIdDataIterator(
            AbstractSenderIdVertexIdData<I, T> vertexIdData) {
    ...
    public void next() {
        //if (senderId == null) {
            senderId = new SenderIdIterationNumber<I>();
        //}
        if (vertexId == null) {
        ...
        try {
            senderId.readFields(extendedDataInput);
